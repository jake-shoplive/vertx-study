...
public class MessageQueueMonitor {
    ...
    private void logQueueStatus() {
        ...
        long tasksStarted = totalTasksStarted.get();
        long tasksCompleted = totalTasksCompleted.get();
        long tasksFailed = totalTasksFailed.get();
        ...
        logger.info("Total Tasks Started: {}", tasksStarted);
        logger.info("Total Tasks Completed: {}", tasksCompleted);
        logger.info("Total Tasks Failed: {}", tasksFailed);
        logger.info("Task Success Rate: {}%", tasksStarted > 0 ? (tasksCompleted * 100) / tasksStarted : 0);
    ...
    public Map<String, Object> getQueueStats() {
        ...
        stats.put("totalTasksStarted", totalTasksStarted.get());
